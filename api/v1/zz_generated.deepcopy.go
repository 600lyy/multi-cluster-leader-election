...
func (in *LeaseStatus) DeepCopyInto(out *LeaseStatus) {
	*out = *in
	if in.ObservedHolderIdentity != nil {
		in, out := &in.ObservedHolderIdentity, &out.ObservedHolderIdentity
		*out = new(string)
		**out = **in
	}
	if in.ObservedAcquireTime != nil {
		in, out := &in.ObservedAcquireTime, &out.ObservedAcquireTime
		*out = (*in).DeepCopy()
	}
}
